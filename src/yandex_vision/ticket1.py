...
image_path = "C:/Users/Vika/PycharmProjects/ttk-bot/pictures/ticket1.jpg"
...
for i, word in enumerate(parsed):
    if word == "ПОЕЗД":
        info["ПОЕЗД"] = parsed[i + 1]
    elif word == "ВАГОН":
        info["ВАГОН"] = parsed[i + 1]
    elif word == "МЕСТО":
        info["МЕСТО"] = parsed[i + 1]
print(info)
